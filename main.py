...
USER_NAME = os.environ.get('USER_NAME', 'ahmmeefhema8')
...
if __name__ == '__main__':
    try:
        ...
        if os.path.exists('dark_mode.svg'):
            svg_overwrite('dark_mode.svg', total_commits, star_count, repo_count, contrib_count, follower_count, loc_data)
        if os.path.exists('light_mode.svg'):
            svg_overwrite('light_mode.svg', total_commits, star_count, repo_count, contrib_count, follower_count, loc_data)
